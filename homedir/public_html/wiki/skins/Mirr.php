 ...
 * @addtogroup Skins
 */
class SkinMirr extends SkinTemplate {
	/** Using mirr. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'mirr';
		$this->stylename = 'mirr';
		$this->template  = 'MirrTemplate';
	}
}
 ...
 * @addtogroup Skins
 */
class MirrTemplate extends QuickTemplate {
	/**
	 * Template filter callback for Mirr skin.
 ...
 class="mediawiki <?php $this->text('nsclass') ?> <?php $this->text('dir') ?> <?php $this->text('pageclass') ?>">
	<div id="globalWrapper">
		<div id="column-content">
			...
			<div id="header"><div><img src="<?php $this->text('logopath') ?>" alt="" /></div></div>
	...
	<div id="p-cactions" class="portlet"><!-- Aumentar o TOP -->
...
<?php if(preg_replace("/([\xC2\xC3])([\x80-\xBF])/e", "chr(ord('\\1')<<6&0xC0|ord('\\2')&0x3F)", $bar) == "Mirr Enciclopédia") { ?>
	<span style="display:block;height:11px;overflow:hidden"></span>
<?php } ?>
...
<?php
			...
			wfRunHooks( 'MirrTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
<?php
...
<?php
		$footerlinks = array(
			'lastmod', 'viewcount', 'numberofwatchingusers', 'newline',
			'credits', 'copyright', 'privacy', 'about', 'disclaimer', 'tagline',
		);
		foreach( $footerlinks as $aLink ) {
			if($aLink == 'newline') {
?>				<li><br /></li>
<?php
			} else if( isset( $this->data[$aLink] ) && $this->data[$aLink] ) {
...
<script type="text/javascript">
	var _gaq = _gaq || [];
	_gaq.push(['_setAccount', 'UA-22917947-2']);
